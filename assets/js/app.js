...
var budgetController = ( function() {
	...
	// Calculate the percentage (each expense divided by the total income):
	...
	// Simply retrieve the percentage from the object and then return it:
	...
	*/
	...
	return {
		...
		// Calculate the percentage for every expense that we have in our object:
...
var UIController = ( function() {
	...
	return {
		...
		displayBudget: function( obj ) {
			var type;
			// Use this ternary operator because we don't know the type yet:
			obj.budget > 0 ? type = "inc" : type = "exp";
			document.querySelector( DOMstrings.budgetLabel ).textContent = formatNumber( obj.budget, type );
			// In these, we know whether the type will be "inc" or "exp", so we can just pass that in specifically:
